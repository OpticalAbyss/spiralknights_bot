...
class SKMarketScraper:
        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                while current_page_num <= max_pages:
                    ...
                    # Use the navigation container to get next button and page info
    ...
    async def extract_history_items(self, page):
        ...
        for i, row in enumerate(rows):
            try:
                ...
                # Extract date/time from third cell
    ...
    def process_history_items(self, items):
        """
        Process and de-duplicate items by checking name, timestamp, and price.
        """
        for item in items:
...
async def main():
    ...
    # You can call scraper.pause_scraping() or scraper.stop_scraping() from another coroutine
    # or based on user input if desired.
